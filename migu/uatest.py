...
def get_headers():
    headers = {
        ...
        'Hosts': 'hm.baidu.com',
        # 'Referer': 'https://www.baidu.com/s?wd=ip%E4%BB%A3%E7%90%86&rsv_spt=1&rsv_iqid=0xf930595c0008f4ad&issp=1&f=8&rsv_bp=0&rsv_idx=2&ie=utf-8&tn=baiduhome_pg&rsv_enter=1&rsv_sug3=8&rsv_sug1=7&rsv_sug7=100',
        'Connection': 'close'}
    return headers
...
resp = session.get('http://www.ip3366.net/free/?stype=1&page=1', headers=headers)
